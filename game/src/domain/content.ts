...
const sharedCards: readonly CardDefinition[] = [
  ...
  },
  {
    ...
    stun: true,
    exhaust: true,
    rules: "Cancel one Task's End Day effect. Exhaust.",
    tags: ["defense", "exhaust", "stun", "reward"],
  },
  {
    id: "health-check",
    name: "Health Check",
    ...
    rules: "Infra 2. Gain 2 Block. Install Guard 2.",
    tags: ["automation", "defense", "reward"],
  },
  {
    id: "rubber-duck-session",
    name: "Rubber Duck Session",
    cost: 1,
    kind: "tactic",
    amount: 0,
    generatedCards: [
    ...
    display: { value: "2", label: "Generate", rules: "Comment + Checklist." },
    rules: "Generate a Comment and a Checklist.",
    tags: ["defense", "review", "reward"],
  },
  {
    id: "small-pr",
    name: "Small PR",
    ...
    exhaust: true,
    display: { value: "2", label: "Any", rules: "Complete: +1 Focus. Exhaust." },
    rules: "Any 2. Verified. If it completes the requirement, gain 1 Focus. Exhaust.",
    tags: ["exhaust", "flexible", "reward"],
  },
  {
    id: "contingency-plan",
    ...
    nextDayCardsDrawn: 2,
    exhaust: true,
    display: { value: "3", label: "Block", rules: "Next Day: draw +2. Exhaust." },
    rules: "Gain 3 Block. Draw 2 additional cards at the start of the next Day. Exhaust.",
    tags: ["defense", "exhaust", "reward"],
  },
  {
    id: "spring-cleaning",
    ...
    exhaust: true,
    display: { value: "ALL", label: "Status", rules: "Exhaust hand. Draw each. Exhaust." },
    rules: "Exhaust every Status card in hand. Draw 1 for each. Exhaust.",
    tags: ["exhaust", "reward"],
  },
  {
    id: "copy-paste",
